  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        alt=""
      />
      <div className="absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white w-10 h-10  md:h-24 md:w-24  xl:w-32 xl:h-32 rounded-full z-0">
